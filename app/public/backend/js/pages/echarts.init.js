...
doughnutChartColors && (dom = document.getElementById("doughnut-chart"), myChart = echarts.init(dom), option = null, option = {
    ...
    series: [{
        ...
        data: [{value: 335, name: "Laptop"}, {value: 310, name: "Tablet"}, {value: 234, name: "Mobile"}, {
            value: 135,
            name: "Others"
        }, {value: 1548, name: "Desktop"}]
    }]
}, option && "object" == typeof option && myChart.setOption(option, !0));
var pieChartColors = getChartColorsArray("pie-chart-marque");
pieChartColors && (dom = document.getElementById("pie-chart-marque"), myChart = echarts.init(dom), app = {}, option = null, option = {
    tooltip: {
        trigger: "item",
        formatter: "{a} <br/>{b} : {c} ({d}%)"
    },
    ...
    series: [{
        ...
        center: ["50%", "60%"],
        data: [
            {value: 335, name: "Suzuki"}, {value: 310, name: "Toyota"}, {value: 234, name: "Peugeot"}, {value: 135, name: "Renault"}, {value: 1548, name: "Hyundai"}],
        itemStyle: {emphasis: {shadowBlur: 10, shadowOffsetX: 0, shadowColor: "rgba(0, 0, 0, 0.5)"}}
    }]
}, option && "object" == typeof option && myChart.setOption(option, !0));
var pieChartColors = getChartColorsArray("pie-chart-energie");
pieChartColors && (dom = document.getElementById("pie-chart-energie"), myChart = echarts.init(dom), app = {}, option = null, option = {
    tooltip: {
        trigger: "item",
        formatter: "{a} <br/>{b} : {c} ({d}%)"
    },
    ...
    series: [{
        ...
        radius: "55%",
        center: ["50%", "60%"],
        data: [{value: 5560, name: "Essence"}, {value: 1900, name: "Gazoil"}],
        itemStyle: {emphasis: {shadowBlur: 10, shadowOffsetX: 0, shadowColor: "rgba(0, 0, 0, 0.5)"}}
    }]
}, option && "object" == typeof option && myChart.setOption(option, !0));
...
scatterChartColors && (dom = document.getElementById("scatter-chart"), myChart = echarts.init(dom), app = {}, option = null, option = {
    ...
    xAxis: {axisLine: {lineStyle: {color: "#8791af"}}, splitLine: {lineStyle: {color: "rgba(166, 176, 207, 0.1)"}}},
    yAxis: {axisLine: {lineStyle: {color: "#8791af"}}, splitLine: {lineStyle: {color: "rgba(166, 176, 207, 0.1)"}}},
    series: [{
        symbolSize: 10,
...
bubbleChartColors && (dom = document.getElementById("bubble-chart"), myChart = echarts.init(dom), app = {}, option = null, option = {
    ...
    xAxis: {
        axisLine: {lineStyle: {color: "#8791af"}},
        splitLine: {lineStyle: {type: "dashed", color: "rgba(166, 176, 207, 0.1)"}}
    },
    yAxis: {
        axisLine: {lineStyle: {color: "#8791af"}},
        splitLine: {lineStyle: {type: "dashed", color: "rgba(166, 176, 207, 0.1)"}},
...
gaugeChartColors && (dom = document.getElementById("gauge-chart"), myChart = echarts.init(dom), app = {}, option = null, option = {
    ...
    series: [{
        ...
        axisLine: {
            lineStyle: {
                color: [[.2, gaugeChartColors[0]], [.8, gaugeChartColors[1]], [1, gaugeChartColors[2]]],
                width: 20
            }
        },
