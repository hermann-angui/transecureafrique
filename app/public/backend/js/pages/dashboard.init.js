...
linechartBasicColors && (options = {
    ...
    series: [{name: "Délivrés", data: [44, 55, 41, 67, 22, 43, 36, 52, 24, 18, 36, 48]},
        {name: "Demandés", data: [13, 23, 20, 8, 13, 27, 18, 22, 10, 16, 24, 22]}],
    xaxis: {categories: ["Jan", "Fev", "Mar", "Avr", "Mai", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]},
